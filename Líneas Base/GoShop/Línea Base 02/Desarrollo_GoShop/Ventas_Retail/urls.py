...
from . import views_access,views_profile, views_shop, views_shopping_cart
...
urlpatterns = [
    ...
    path('products/<str:text>', views_shop.get_products, name='products'),
    ...
    path('profile/payment/add_payment_method', views_profile.add_payment_method, name='add_payment_method'),
    path('profile/payment/remember_payment_method', views_profile.remember_payment_method,name='remember_payment_method'),
